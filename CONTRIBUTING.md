...
Welcome to the [erp-crm](https://github.com/surajphirke/erp-crm) repository! We're excited that you're interested in contributing. Please take a moment to review this document to ensure a smooth collaboration process.
...
- please make sure it was not asked before here [issues](https://github.com/surajphirke/erp-crm/issues).
- make sure it is not work in progress here [pull requests](https://github.com/surajphirke/erp-crm/pulls).
- you can then [create an issue](https://github.com/surajphirke/erp-crm/issues/new/choose) with the following information:
